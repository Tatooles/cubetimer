        ...
        <header className="col-span-full flex items-center gap-4 border-b border-white/[0.07] px-4">
          ...
          <nav className="flex h-full items-stretch">
            <button
              ...
              className={`relative px-4 text-sm font-medium ${activeSection === "timer" ? "text-indigo-200" : "text-zinc-500 hover:text-zinc-200"}`}
            >
              <span>Timer</span>
              {activeSection === "timer" ? (
            ...
            <button
              ...
              className={`relative px-4 text-sm font-medium ${activeSection === "training" ? "text-indigo-200" : "text-zinc-500 hover:text-zinc-200"}`}
            >
              <span>Training</span>
